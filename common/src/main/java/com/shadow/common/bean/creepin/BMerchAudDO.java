package com.shadow.common.bean.creepin;
...
public class BMerchAudDO {
     ...
     * 公共账户账号
     */
    @Column(name = "ACCOUNT_ID_COMMON")
    private String accountIdCommon;

    /**
     * 公共账户户名
     */
    @Column(name = "ACCOUNT_NAME_COMMON")
    private String accountNameCommon;

    /**
     * 公共账户户名密文
     */
    @Column(name = "ACCOUNT_NAME_ENCRYPT_COMMON")
    private String accountNameEncryptCommon;

    /**
     * 公共账户账号密文
     */
    @Column(name = "ACCOUNT_ID_ENCRYPT_COMMON")
    private String accountIdEncryptCommon;
     ...
     * 特约商户类型
     */
    @Column(name = "SPECIAL_MERCH_TYPE")
    private String specialMerchType;

    /**
     * 对私签证机关
     */
    @Column(name = "PRIVATE_ISSUE")
     ...
     * 对私职业
     */
    @Column(name = "PRIVATE_OCCUPATION_CODE")
    private String privateOccupationCode;

    /**
     * h5流水跟踪号
     */
    @Column(name = "H5_TRACE_NO")
    private String h5TraceNo;
}